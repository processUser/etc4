...
<head>
    ...
    <!-- style -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/res/css/common.css?va=1">
...
<section>
    ...
    <section class="slideWrap">
        ...
        <div class="btnLR po_absolute">
            <!-- 좌우버튼 -->
            <ul class="w1200">
                <li class="left po_absolute"><a href=""><span class="hide">좌</span></a></li>
    ...
    <section class="w1200 section2">
        ...
        <!-- 남은시간 -->
        <article>
            <p>12월 14일(화)에 받을 수 있어요</p>
            <p>오전 7시까지 주문하면 다음날 배송됩니다.</p>
            <p>남은시간 <span>00:00:00</span></p>
        </article>
    </section>
    <!-- 추천 메뉴 -->
    <section class="w1200 section3">
        <div>
            ...
            <div>
                <h2>메뉴<br>추천드려요</h2>
                <p><a href="">로그인</a>하시면 고객님의 구매내역과<br>맛취향에 따라 딱맞는 맛있는 메뉴를 추천드려요</p>
                <ul>
                    <li><a href=""><span class="hide">좌</span></a></li>
                    <li><span>1</span>&#47;<span>5</span></li>
                    <li><a href=""><span class="hide">우</span></a></li>
                </ul>
            </div>
        </div>
        <!-- 매콤한맛 -->
    ...
    <aside class="aside">
        <ul>
            <li><a href=""><img src="/res/img/main/ad/20211203164840711.jpg" alt=""></a></li>
            <li><a href=""><img src="/res/img/main/ad/20211130170934313.jpg" alt=""></a></li>
            <li><a href=""><img src="/res/img/main/ad/20210930114221992.jpg" alt=""></a></li>
        </ul>
        <div>
            <ul>
                <li><a href=""><span class="hide">좌</span></a></li>
                <li>
                    <div class="choose"><a href="" ><span class="hide">1</span></a></div>
    ...
    <section class="w1200 section7">
        <article class="article7_1">
            ...
            <dl>
                <dt>
                    <a href=""><img src="/res/img/main/product/132/20211206142339970.png" alt="리코타치즈 콜드파스타"></a>
                </dt>
                <dd>
                    <a href="">
                        <p>리코타치즈 콜드파스타</p>
                        <p><span>28,800원</span>&#47;<span class="a">3인분</span></p>
                    </a>
                    <a href=""><span class="hide">장바구니</span></a>
                </dd>
                <dt>
